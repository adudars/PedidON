...
insert into item_cardapio(nome_item, descricao, preco, fk_id_categoria, fk_id_tamanho)
values('Stella Artois', 'Stella Artois Long Neck', 5.99, 2, 4),
